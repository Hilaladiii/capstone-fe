      ...
      <section className="w-full relative flex justify-center items-center">
        <div className="size-250 bottom-52 right-48 rounded-full bg-gradient-to-b from-[#131E30] to-[#17294C] border-6 border-secondary text-white flex flex-col justify-center items-center p-4 relative">
          <div className="z-10 absolute top-2/4 left-4/12">
            <h1 className="text-5xl font-bold mb-6">Welcome to PKLapps!</h1>
            <p className="text-xl leading-relaxed max-w-md">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur
              maiores eum iure totam voluptatibus fugiat consectetur! Velit
              numquam consequuntur rem est culpa eum facere dolorum deserunt
              atque.
            </p>
          </div>
