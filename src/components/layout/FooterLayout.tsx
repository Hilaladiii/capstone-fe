...
const FooterLayout = () => {
  const links = [
    { icon: <FaInstagram />, href: "https://www.instagram.com/filkomub", label: "@filkomub" },
    { icon: <PiGlobeBold />, href: "https://filkom.ub.ac.id", label: "filkom.ub.ac.id" },
    { icon: <RiCustomerService2Fill />, href: "https://halofilkom.ub.ac.id", label: "halofilkom.ub.ac.id" },
  ];
