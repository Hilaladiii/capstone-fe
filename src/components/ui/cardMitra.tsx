...
const CardMitra: React.FC<CardProps> = ({ title, address, imageUrl }) => {
  return (
    <div className="bg-white rounded-xl border-1 border-black overflow-hidden flex flex-col items-center p-6"
