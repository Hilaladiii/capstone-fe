    ...
    <div className="flex flex-col items-center bg-primary min-h-screen">
      ...
      <div className="text-black bg-white w-full max-w-7xl rounded-2xl flex flex-col items-center justify-center mb-10 shadow-lg">
        ...
        <div className="flex gap-x-230 justify-between">
          <span className="text-white bg-secondary text-sm rounded-full px-10 py-2 mt-6">
            {new Date(announcement.createdAt).toLocaleDateString()}
          </span>
          <Button
            variant="secondary"
            className="text-sm rounded-full px-10 py-2 mt-6"
          >
            Kembali
          </Button>
        </div>

        <h1 className="text-lg font-semibold mt-4 text-center flex justify-center items-center bg-black text-white h-14 w-17/18 rounded-2xl">
          {announcement.title}
        </h1>
          ...
          {announcement.fileUrl && (
            <div className="text-start items-start flex mb-6 border-2 border-secondary rounded-2xl p-2 justify-center ">
              <a
                ...
                className="text-secondary hover:text-secondary text-start font-semibold"
                download
              >
                Unduh Dokumen
              </a>
        ...
        <div className="flex flex-col w-full mb-10 px-4">
          <div className="flex flex-col gap-3 mx-6 border-2 border-black rounded-2xl px-4 py-4">
            <Button className="w-40 rounded-full bg-secondary cursor-pointer text-white px-6 py-2 text-sm">
              Reply
            </Button>
            <input
              type="text"
              placeholder="Masukkan tautan berkas"
              className="w-full px-4 py-2 text-sm border-2 border-black rounded-full"
            />
          </div>
        </div>
      </div>
