...
import { InternshipExtensionApplication } from '../../../common/types/internshipp.type';
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center font-semibold items-center min-w-6xl mx-auto py-6 space-y-4">
            ...
            {fields.map((field, index) => (
              <div key={field.id} className="space-y-2 mb-4 border p-4 mx-4 rounded bg-white relative">
                ...
                <Input
                  ...
                  placeholder="Masukkan sks anggota"
                  className='min-w-5xl w-full'
                />
        ...
        <div className="w-full space-y-4">
          <Input
            ...
            label="Masukkan tanggal mulai masa pelaksanaan"
            register={register}
          ...
          <Input
            ...
            label="Masukkan tanggal selesai masa pelaksanaan"
            register={register}
          ...
          <Input
            ...
            label="Masukkan tanggal mulai masa perpanjangan"
            register={register}
          ...
          <Input
            ...
            label="Masukkan tanggal selesai masa perpanjangan"
            register={register}
          ...
          <div className='min-w-6xl w-full'>
            ...
            <textarea
              ...
              rows={3}
            />
            {errors.reasonExtension && (
              <p className="text-red-500 text-sm mt-1">{errors.reasonExtension.message}</p>
            )}
          </div>
        </div>
