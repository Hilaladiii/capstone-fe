...
const AnnouncementSection = () => {
  const { data: announcementsResponse, isLoading, isError } = useAnnouncements(1, 10, "desc", "");
  ...
  return (
    <section className="h-146 bg-primary flex flex-col py-10">
      <h1 className="text-2xl font-bold mb-4 px-24 text-white">Pengumuman</h1>
        ...
        {sortedAnnouncements.length === 0 ? (
          ...
          sortedAnnouncements.map((announcement) => (
            <li
              ...
              onClick={() => window.location.href = `/pengumuman/${announcement.announcementId}`}
            >
